...
urlpatterns = [
    ...
    path('health/', views.api_health, name='health_slash'),
    ...
    path('api/parse-recipe', views.api_parse_recipe, name='api_parse_recipe_no_slash'),
    path('api/parse-recipe/', views.api_parse_recipe, name='api_parse_recipe'),
    path('api/parse-ingredients', views.api_parse_ingredients, name='api_parse_ingredients_no_slash'),
    path('api/parse-ingredients/', views.api_parse_ingredients, name='api_parse_ingredients'),
    path('api/parse-images', views.api_parse_images, name='api_parse_images_no_slash'),
    ...
    path('api/health', views.api_health, name='api_health_no_slash'),
